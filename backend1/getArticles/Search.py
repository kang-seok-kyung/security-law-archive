...
KEYWORD_WEIGHTS = {
    ...
    "해킹": {"정보통신망이용촉진및정보보호등에관한법률": 0.30},
    "디도스": {"정보통신망이용촉진및정보보호등에관한법률": 0.25},
    "랜섬웨어": {"정보통신망이용촉진및정보보호등에관한법률": 0.25},
    "악성코드": {"정보통신망이용촉진및정보보호등에관한법률": 0.20},
    ...
    # 중복 법률 적용 예시 (추가)
    "데이터 유출": {"개인정보보호법": 0.20, "정보통신망이용촉진및정보보호등에관한법률": 0.20},
    "정보 보호": {"개인정보보호법": 0.15, "정보통신망이용촉진및정보보호등에관한법률": 0.15},
